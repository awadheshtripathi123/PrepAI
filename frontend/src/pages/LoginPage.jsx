  ...
  const handleAppleLogin = async () => {
    try {
      ...
      if (data.success) {
        ...
        alert(data.error || "Apple login failed");
      }
    } catch (error) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-[380px] rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 p-6 shadow-2xl">
        ...
        <h2 className="text-white text-xl font-semibold mb-1">Login Account</h2>
        <p className="text-gray-400 text-sm mb-5">Login to continue your account</p>
        ...
        <p className="text-gray-400 text-sm text-center mt-4">
          ...
          <span
            onClick={() => navigate("/signup", { state: { background } })}
